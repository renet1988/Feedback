  ...
  render(){
    return (
      <div className="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mt-2 mb-3 border-dark">
        ...
        <Modal size="lg" show={this.state.show} onHide={this.handleStatusClose}>
          <Modal.Body>
            <form>
              ...
              <div className="container row">
                <button className="btn btn-outline-primary col-6" type="button" onClick={ () => this.props.onUpdateState( this.props.item , newStatus , this.handleStatusClose() )}>
                    Save Changes
                </button>
                <button className="btn btn-outline-dark col-6" type="button" onClick={this.handleStatusClose} >Cancel</button>
              </div>
            </form>
          </Modal.Body>
        </Modal>
